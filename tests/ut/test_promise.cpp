...
//               }
//               THEN("the future_object_base should not be valid") {
...
//         }
//
//         THEN("future_object_base is not valid") {
//            REQUIRE_FALSE(awaiter.valid());
//         }
//      }
//   }
